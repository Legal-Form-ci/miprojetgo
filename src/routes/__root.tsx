...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MiProjet Go — L'app des entrepreneurs" },
      { name: "description", content: "Gestion des ventes, dépenses, stocks et équipes pour commerçants, artisans et TPE." },
      { name: "theme-color", content: "#1E4CA1" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "default" },
      { name: "apple-mobile-web-app-title", content: "MiProjet Go" },
      { property: "og:title", content: "MiProjet Go — L'app des entrepreneurs" },
      { property: "og:description", content: "Gestion des ventes, dépenses, stocks et équipes pour commerçants, artisans et TPE." },
