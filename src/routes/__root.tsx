...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "MiPROJET Go" },
      { property: "og:title", content: "MiPROJET Go — Gestion commerciale des TPE ivoiriennes" },
      { property: "og:description", content: "Enregistrez ventes, dépenses et stocks à la voix ou en un geste, même hors ligne. La solution MiPROJET pour maquis, boutiques, restaurants et artisans." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "MiPROJET Go" },
      { property: "og:url", content: "https://go.ivoireprojet.com/" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "MiPROJET Go — Gestion commerciale des TPE ivoiriennes" },
      { name: "twitter:description", content: "Enregistrez ventes, dépenses et stocks à la voix ou en un geste, même hors ligne. La solution MiPROJET pour maquis, boutiques, restaurants et artisans." },
    ...
    links: [
      ...
      { rel: "apple-touch-startup-image", href: "/splash/splash-1242x2688.png", media: "(device-width: 414px) and (device-height: 896px) and (-webkit-device-pixel-ratio: 3)" },
      ...
      { rel: "apple-touch-startup-image", href: "/splash/splash-828x1792.png", media: "(device-width: 414px) and (device-height: 896px) and (-webkit-device-pixel-ratio: 2)" },
